...
interface MyDao{
    ...
    @Query ("select count(*) from Codes where ItemID= :itemID and ColorID= :colorID and image is not null")
    fun existImage(itemID: Int, colorID: Int): Int
